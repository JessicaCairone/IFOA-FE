...
characters.push('C3P-O');
characters.push('Valerio');
characters.push('Blondie');*/
...
for(let i = 0; i < starWarsCharacters.length; i++){
 ...
 document.getElementById('femaleCharacters').innerHTML += femaleCharacters;
...
console.log('Gli occhi dei vari personaggi sono: ');
console.log(eyeColor);
document.getElementById('eyeColor').innerHTML = JSON.stringify(eyeColor);
...
console.log(femaleCharacters);
console.log('Array characters prima dell\'eliminazione: ' , characters);
